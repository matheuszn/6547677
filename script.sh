...
then
	...
	chmod +x /bin/sshmonitor
        ...
        wget https://raw.githubusercontent.com/RicKbrL/VpsConf/master/badvpn.sh -O /bin/badvpn 1> /dev/null 2> /dev/stdout
	...
	chmod +x /bin/logins
        ...
        sleep 2
		 ...
		 tput setaf 5 ; tput bold ; echo "instalando o bloqueio torrent, icmp..." ; tput sgr0
        wget https://raw.githubusercontent.com/matheuszn/6547677/master/bloquear.sh -O /bin/bloquear 1> /dev/null 2> /dev/stdout
        chmod +x /bin/bloquear
        sleep 2
		
		 tput setaf 5 ; tput bold ; echo "instalando a restauraçao do bloqueio torrent, icmp..." ; tput sgr0
        wget https://raw.githubusercontent.com/matheuszn/6547677/master/desbloquear.sh -O /bin/desbloquear 1> /dev/null 2> /dev/stdout
        chmod +x /bin/desbloquear
        sleep 2
